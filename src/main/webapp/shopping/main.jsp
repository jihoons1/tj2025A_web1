...
<body>
    <div> <h2> 쇼핑몰 회원관리 ver 1.0 </h2></div>
    <div>
        <ul>
            <li><a href="/shopping/add.jsp" > 회원등록 </a></li>
            <li><a href="/shopping/print.jsp" > 회원목록조회 </a></li>
            <li><a href="#" > 회원매출조회 </a></li>
            <li><a href="/shopping/main.jsp" > 홈으로 </a></li>
        </ul>
    </div>
    <div> <h3> 쇼핑몰 회원관리 프로그램 </h3> </div>
